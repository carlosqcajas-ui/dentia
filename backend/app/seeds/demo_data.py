"""Demo data definitions for Dentia.
...
def get_clinic_data() -> dict:
    ...
    return {
        ...
        # Dentia is a single-market (Bolivia) deployment: tax_id, address,
        # phone, currency and timezone are always Bolivia-correct
        # regardless of the seed's UI language — only clinic/user/patient
        # display strings are translated, never the country.
        "tax_id": "1023456011",
        "address": {
            "street": t(
                {
