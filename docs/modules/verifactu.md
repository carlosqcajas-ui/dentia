...
Dentia is international software; AEAT/RRSIF is Spain-only. The
...
VERIFACTU_SOFTWARE_NAME=Dentia    # Optional, defaults to "Dentia"
...
|---|---|
| Managed SaaS at e.g. dentia.com | The SaaS operator |
